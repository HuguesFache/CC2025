...
/** Implements IObserver based on the partial implementation CDialogObserver.
	...
	@ingroup xlogin
*/
class XLGDialogObserver : public CDialogObserver
{
	public:
		/**
			Constructor.
		...
		*/
		XLGDialogObserver(IPMUnknown* boss) : CDialogObserver(boss) {}

		/** Destructor. */
		virtual ~XLGDialogObserver() {}
...
/* CREATE_PMINTERFACE
 ...
 application.
*/
CREATE_PMINTERFACE(XLGDialogObserver, kXLGDialogObserverImpl)

/* AutoAttach
*/
void XLGDialogObserver::AutoAttach()
{
...
/* AutoDetach
*/
void XLGDialogObserver::AutoDetach()
{
