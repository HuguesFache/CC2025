...
/*************** Conversion Tables ******************/
	...
	/* 60 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* 70 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* 80 */	'Ç',	'ü',	'é',	'â',	'ä',	'à',	'å',	'ç',	'ê',	'ë',	'è',	'ï',	'î',	'ı',	'Ä',	'Â',
	/* 90 */	'É',	'æ',	'Æ',	'ô',	'ö',	'ò',	'û',	'ù',	'ÿ',	'Ö',	'Ü',	'¢',	'£',	'¥',	0x00,	'ƒ',
	/* A0 */	'á',	'ì',	'ò',	'ù',	'ñ',	'Ñ',	'ª',	'º',	'¿',	0x00,	0x00,	0x00,	0x00,	0x00,	0xae,	0xaf,
	/* B0 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* C0 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* D0 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* E0 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	...
	/* 80 */	0xDB,	0x00,	0x00,	'ƒ',	'„',	'…',	'†',	'‡',	'^',	'‰',	0x00,	'<',	'Œ',	0x00,	0x00,	0x00,
	/* 90 */	0x00,	'‘',	'’',	'“',	'”',	'•',	'–',	'—',	'”',	'™',	0x00,	'>',	'œ',	0x00,	0x00,	'Ÿ',
	/* A0 */	0xCA,	'¡',	'¢',	'£',	0xDB,	0xB4,	0x7C,	'§',	'_',	'©',	0xBB,	'«',	'-',	'-',	'®',	'—',
	/* B0 */	0xA1,	'±',	0x00,	0x00,	'\'',	'µ',	0xA6,	'•',	0xFC,	0x00,	0x00,	'»',	0x00,	0x00,	0x00,	'¿',
	/* C0 */	'À',	'Á',	'Â',	'Ã',	'Ä',	0x81,	'Æ',	'Ç',	'È',	'É',	'Ê',	'Ë',	'Ì',	'Í',	'Î',	'Ï',
	/* D0 */	0x00,	'Ñ',	'Ò',	'Ó',	'Ô',	'Õ',	'Ö',	0x00,	0xAF,	'Ù',	'Ú',	'Û',	'Ü',	0xD9,	0xDE,	'ß',
	/* E0 */	'à',	'á',	'â',	'ã',	'ä',	0x8c,	'æ',	'ç',	'è',	'é',	'ê',	'ë',	'ì',	'í',	'î',	'ï',
	/* F0 */	0x00,	'ñ',	'ò',	'ó',	'ô',	'õ',	'ö',	'÷',	0xBF,	'ù',	'ú',	'û',	'ü',	0xD8,	0xDF,	'ÿ',
	
	};

	// Table for média system
...
// ------------------------------------
	...
	/* 20 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	'í',	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* 30 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* 40 */	0x40,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* 50 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* 60 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* 70 */	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,
	/* 80 */	0xC7,	0xFC,	'È',	0xE2,	0xE4,	'‡',	0xE5,	0xE7,	0xEA,	0xEB,	'Ë',	0xEF,	0xEE,	0x00,	0xC4,	0x00,
