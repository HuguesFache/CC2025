...
// Special Gedimat : Balisage automatique
#define GEDIMAT_EXPRESSION_2022 L"(\\d{8})(.{1,15}?)(\\d+(?:,\\d*)*)\\s*€(.{1,20}?)(\\d+(?:,\\d*)*)\\s*\\x24\\x24(.{1,30}?)(\\d+(?:,\\d*)*)\\s*\\x24(.{1,20}?)(\\d+(?:,\\d*)*)\\s*\\x24\\x24\\x24"
#if __APPLE__
#define GEDIMAT_EXPRESSION_2015 L"(\\d{8})(.{1,15}?)(\\d+(?:,\\d*)*)\\s*€(.{1,20}?)(\\d+(?:,\\d*)*)\\s*\\x24" // Expression v2015, prix secondaire de la forme "00$" // GD 15.09.2015
#define GEDIMAT_EXPRESSION L"(\\d{8})(.{1,15}?)(\\d+(?:,\\d*)*)\\s*€"   // Expression régulière -> Balisage auto des prix
#else
#define GEDIMAT_EXPRESSION_2015 L"(\\d{8})(.{1,15}?)(\\d+(?:,\\d*)*)\\s*\\p{Sc}(.{1,20}?)(\\d+(?:,\\d*)*)\\s*\\x24" // Expression v2015, prix secondaire de la forme "00$" // GD 15.09.2015
#define GEDIMAT_EXPRESSION L"(\\d{8})(.{1,15}?)(\\d+(?:,\\d*)*)\\s*\\p{Sc}"   // Expression régulière -> Balisage auto des prix
#endif
#define GEDIMAT_EXPRESSION2 "(\\d{8})"								   // Expression régulière -> Balisage auto des references
#define REFERENCE_LENGTH 8 
#define REFERENCE_COUNT 4 
