...
*/
class XPGUIImageDragDropSource : public CDragDropSource
{
public:
	/**
		Constructor.
	...
	*/
	XPGUIImageDragDropSource(IPMUnknown* boss);

	/**
		Destructor.
	*/
	~XPGUIImageDragDropSource();
...
*/
CREATE_PMINTERFACE(XPGUIImageDragDropSource, kXPGUIImageDragDropSourceImpl)

/* Constructor
*/
XPGUIImageDragDropSource::XPGUIImageDragDropSource(IPMUnknown* boss)
...
/* Destructor
*/
XPGUIImageDragDropSource::~XPGUIImageDragDropSource()
{
}
...
/* WillDrag
*/
bool16 XPGUIImageDragDropSource::WillDrag(IEvent* event) const {
	IDFile contentFile;
...
/* DoAddDragContent
*/
bool16 XPGUIImageDragDropSource::DoAddDragContent(IDragDropController* controller){
...
/* getContentFile
*/
bool16 XPGUIImageDragDropSource::getContentFile(IDFile& contentFile, PMString& legend, PMString& credit) const
{
...
*/
bool16 XPGUIImageDragDropSource::doAddSysFileDragContent(
...
// End, XPGUIImageDragDropSource.cpp.
